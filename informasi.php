...
<!-- Navbar End -->
    ...
    <div class="container-fluid page-header mb-5 position-relative overlay-bottom">
        <div class="d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5" style="min-height: 400px">
            <h1 class="display-4 mb-3 mt-0 mt-lg-5 text-white text-uppercase">INFORMASI DESA</h1>
    ...
    <div class="container-fluid pt-5">
        <div class="container">
            <div class="section-title">
                <h4 class="text-primary text-uppercase" style="letter-spacing: 5px;">Sekilas Tentang Desa</h4>
                <h1 class="display-4">Informasi Lengkap Desa Teluk Nangka</h1>
            </div>
...
Dapatkan kabar kegiatan, pengumuman penting, dan layanan masyarakat langsung ke email Anda.</p>
        ...
        <div class="container-fluid text-center text-white border-top mt-4 py-4 px-sm-3 px-md-5"
            ...
            <p class="m-0 text-white">Design by KKM 2025 UNIVERSITAS PGRI PONTIANAK</p>
        </div>
    </div>
    <!-- Footer End -->
